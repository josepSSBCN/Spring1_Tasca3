...
public class Main {
	...
	private static void iniciar() {
		...
		try {
			...
			do {
				...
				// 3) Control si hi ha persones x mostrar, o estem en les opcions 0 o 1
				opcio = (persones.size() > 0 || opcio <= 1) ? opcio : 100;
	...
	private static Persona introduirPersona(ArrayList<Persona> persones) {
		...
		try {
			...
			nom = ToolsGlbl.scannerStrg("\r\nOPCIÓ 1: Introduir Persona.\r\nIntroduïu el nom de la persona...", false);
			cognom = ToolsGlbl.scannerStrg("Introduïu el cognom de la persona...", true);
			dni = ToolsGlbl.scannerStrg("Introduïu el dni de la persona...", false);
